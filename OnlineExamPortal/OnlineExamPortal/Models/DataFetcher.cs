...
namespace OnlineExamPortal.Models
{
    public class DataFetcher
    {
        ...
        public IEnumerable<Analysis> GetQuestionsByUserAndTopic(int UserId, int TopicId)
        {
            connection.Open();
            string questionsQuery = "SELECT Q.QuestionId AS QId, Q.Question, Q.CorrectOption, R.SelectedOption, " +
